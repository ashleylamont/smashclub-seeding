...
export function GuestReportingControls({ planId, closed, published }: { planId: string; closed: boolean; published: boolean }) {
  ...
  return <section className="card guest-controls"><h3>Guest score reporting</h3><p className="muted">Each QR link works for at least an hour, even after the screen rotates to a new code. Scanning it gives an hour of reporting access. Scores need TO approval unless immediate acceptance is enabled for a self-running pool.</p>
