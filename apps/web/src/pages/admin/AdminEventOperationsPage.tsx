...
export function EventOperationsPanel({ planId }: { planId: string }) {
  ...
  return <div className="ops-page">
    ...
    <section className="card ops-setup"><div><h3>Match desk</h3><p className="muted">Prepare pool matches from the current roster and imported brackets. Recorded scores stay intact.</p></div><button className="btn" disabled={pending || closed} onClick={() => void act(() => trpc.eventOps.prepare.mutate({ planId }), 'Match queue refreshed')}>Prepare / refresh matches</button></section>
