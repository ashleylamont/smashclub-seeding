...
function PlayerReports({ data, disabled, act }: { data: Overview; disabled: boolean; act: Action }) {
  ...
  return <section className="card" id="score-submissions"><h3>Score submissions</h3><p className="muted">These submissions need review. Self-running pools can confirm results immediately when enabled.</p><ReportRows data={data} disabled={disabled} act={act} /></section>;
}
